...
• Solicitamos informações pessoais apenas quando realmente precisamos delas para lhe fornecer um serviço. Fazemo-lo por meios justos e legais, com o seu conhecimento e consentimento. Também informamos por que estamos coletando e como será usado. Além disso, informamos que as solicitações de permissão e APIs que acessam informações confidenciais, como a localização em segundo plano, serão solicitadas somente após seu consentimento explícito. É importante observar que você tem o direito de recusar o consentimento, ciente de que isso pode afetar a qualidade de alguns dos serviços que oferecemos.''',
                fontSize: 18,
